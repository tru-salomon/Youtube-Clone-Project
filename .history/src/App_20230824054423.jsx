...
export default function App() {
  ...
  useEffect(() => {
    let endpoint = searchTerm
      ? `${YT_API_ENDPOINT}?part=snippet&maxResults=10&q=${searchTerm}&regionCode=US&key=${YT_API_KEY}`
      : `${YT_API_ENDPOINT}?part=snippet&order=viewCount&maxResults=50&regionCode=US&key=${YT_API_KEY}`;
